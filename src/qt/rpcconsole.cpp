                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzfuchaPathCustom = GetArg("-zfuchabackuppath", "");
    ...
    if(!strzfuchaPathCustom.empty()) {
        ui->wallet_customzfuchabackuppath->setText(QString::fromStdString(strzfuchaPathCustom));
        ui->wallet_customzfuchabackuppath_label->setVisible(true);
        ui->wallet_customzfuchabackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzfuchaPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the fucha RPC console.") + "<br>" +
