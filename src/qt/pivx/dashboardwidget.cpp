    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of FUCHA earned via Staking & Masternodes"));
	...
	ui->labelAmountMNRewards->setText("0 FUCHA");
...
bool DashboardWidget::loadChartData(bool withMonthNames)
{
    ...
    chartData->amountsByCache = getAmountBy(); // pair FUCHA
