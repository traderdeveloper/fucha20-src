...
/** Utility functions used by the fucha Qt UI.
 */
namespace GUIUtil
{
...
// Render fucha addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZfucha = false);
...
// Parse "fucha:" URI into recipient object, return true on successful parsing
