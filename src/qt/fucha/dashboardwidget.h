...
#include "qt/fucha/furabstractlistitemdelegate.h"
...
#include "config/fucha-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qreal maxValue = 0;
    qint64 totalfucha = 0;
    qint64 totalZfucha = 0;
    QList<qreal> valuesfucha;
    QList<qreal> valueszfucha;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(fuchaGUI* _window);
    ~DashboardWidget();
