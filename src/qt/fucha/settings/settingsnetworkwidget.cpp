...
#include "qt/fucha/settings/settingsnetworkwidget.h"
#include "qt/fucha/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/fucha/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(fuchaGUI* _window, QWidget *parent) :
