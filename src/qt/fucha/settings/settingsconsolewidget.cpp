...
#include "qt/fucha/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/fucha/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(fuchaGUI* _window, QWidget *parent) :
