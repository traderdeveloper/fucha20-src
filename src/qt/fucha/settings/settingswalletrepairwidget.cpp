...
#include "qt/fucha/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/fucha/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(fuchaGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to fuchaGUI::handleRestart()
