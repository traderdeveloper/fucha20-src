...
#include "qt/fucha/forms/ui_masternodewizarddialog.h"
    ...
    walletModel(model)
{
    ...
    ui->lineEditPort->setPlaceholderText("e.g 18145");
    ...
    if(walletModel->isTestNetwork()){
        ...
        ui->lineEditPort->setText("18152");
    } else {
        ui->lineEditPort->setText("18145");
    }
