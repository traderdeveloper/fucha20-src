...
#include "qt/fucha/coldstakingwidget.h"
#include "qt/fucha/forms/ui_coldstakingwidget.h"
#include "qt/fucha/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/fucha/requestdialog.h"
#include "qt/fucha/tooltipmenu.h"
#include "qt/fucha/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(fuchaGUI* parent) :
    PWidget(parent),
    ui(new Ui::ColdStakingWidget)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your fuchas and let a hot node (24/7 online node)\nstake in your behalf, keeping the keys in a secure place offline."));
    ...
    ui->labelSubtitle2->setText(tr("Delegate or Accept fucha delegation"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select fucha outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 fucha" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
