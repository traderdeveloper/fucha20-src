...
#include "qt/fucha/coincontrolfuchawidget.h"
#include "qt/fucha/forms/ui_coincontrolfuchawidget.h"

CoinControlfuchaWidget::CoinControlfuchaWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlfuchaWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select fucha Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("fucha");
    ...
    ui->labelValueAfter->setText("0.00 fucha");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 fucha");
    ui->labelValueFee->setText("0.00 fucha");
...
CoinControlfuchaWidget::~CoinControlfuchaWidget()
{
    delete ui;
}
