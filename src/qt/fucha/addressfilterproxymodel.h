...
#ifndef fucha_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define fucha_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //fucha_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
