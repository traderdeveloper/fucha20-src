...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, fuchaGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, fuchaGUI *gui, double posX = 3);
