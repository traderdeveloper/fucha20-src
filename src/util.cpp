...
const char * const PIVX_CONF_FILENAME = "FUCHA.conf";
const char * const PIVX_PID_FILENAME = "FUCHA.pid";
...
{
// Windows < Vista: C:\Documents and Settings\Username\Application Data\FUCHA
// Windows >= Vista: C:\Users\Username\AppData\Roaming\FUCHA
// Mac: ~/Library/Application Support/FUCHA
// Unix: ~/.FUCHA
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "FUCHA";
#else
    fs::path pathRet;
    ...
    std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty FUCHA.conf if it does not exist
        ...
        if (configFile != NULL) {
	        ...
	        strHeader += "\nrpcport=26144\naddnode=seed1.fucha.rocks:26145\naddnode=seed2.fucha.rocks:26145\naddnode=seed3.fucha.rocks:26145\naddnode=seed4.fucha.rocks:26145\naddnode=seed5.fucha.rocks:26145\naddnode=seed6.fucha.rocks:26145\naddnode=seed7.fucha.rocks:26145\naddnode=seed8.fucha.rocks:26145\n";
    ...
    for (boost::program_options::detail::config_file_iterator it(streamConfig, setOptions), end; it != end; ++it) {
        // Don't overwrite existing settings so command line settings override FUCHA.conf
