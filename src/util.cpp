...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL) {
        ...
        if (ptrCategory.get() == NULL) {
            ...
            // "fucha" is a composite category enabling all fucha-related debug output
            if (ptrCategory->count(std::string("fucha"))) {
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "fucha.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "fuchad.pid"));
