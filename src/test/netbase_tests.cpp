...
BOOST_AUTO_TEST_CASE(netbase_networks)
{
    ...
    BOOST_CHECK(ResolveIP("2001::26144").GetNetwork()                             == NET_IPV6);
...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:26145", "127.0.0.1", 26145));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:26145", "127.0.0.1", 26145));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:26145", "::ffff:127.0.0.1", 26145));
    BOOST_CHECK(TestSplitHost("[::]:26145", "::", 26145));
    BOOST_CHECK(TestSplitHost("::26145", "::26145", -1));
    BOOST_CHECK(TestSplitHost(":26145", "", 26145));
    BOOST_CHECK(TestSplitHost("[]:26145", "", 26145));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:26145", "127.0.0.1:26145"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:26145", "[::]:26145"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
...
BOOST_AUTO_TEST_CASE(validate_test)
{
    ...
    std::list<std::string> validIPv6 = {"1111:2222:3333:4444:5555:6666::26144", "2001:0002:6c::430", "2002:cb0a:3cdd:1::1"};
    ...
    std::list<std::string> invalidIPv6 = {"1111:2222:3333:4444:5555:6666:7777:26144:9999", "2002:cb0a:3cdd::1::1", "1111:2222:3333:::5555:6666:7777:26144"};
