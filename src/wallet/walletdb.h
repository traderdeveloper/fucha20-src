...
public:
    ...
    bool WriteZfuchaSeed(const uint256& hashSeed, const std::vector<unsigned char>& seed);
    bool ReadZfuchaSeed(const uint256& hashSeed, std::vector<unsigned char>& seed);
    bool ReadZfuchaSeed_deprecated(uint256& seed);
    bool EraseZfuchaSeed();
    bool EraseZfuchaSeed_deprecated();

    bool WriteZfuchaCount(const uint32_t& nCount);
    bool ReadZfuchaCount(uint32_t& nCount);
