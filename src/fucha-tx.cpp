...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("fucha Coin fucha-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  fucha-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded fucha transaction") + "\n" +
                               "  fucha-tx [options] -create [commands]   " + _("Create hex-encoded fucha transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded fucha transaction
