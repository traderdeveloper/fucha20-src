...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* FUCHA features */
        {"FUCHA", "listmasternodes", &listmasternodes, true },
        {"FUCHA", "getmasternodecount", &getmasternodecount, true },
        {"FUCHA", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"FUCHA", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"FUCHA", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"FUCHA", "masternodecurrent", &masternodecurrent, true },
        {"FUCHA", "startmasternode", &startmasternode, true },
        {"FUCHA", "createmasternodekey", &createmasternodekey, true },
        {"FUCHA", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"FUCHA", "listmasternodeconf", &listmasternodeconf, true },
        {"FUCHA", "getmasternodestatus", &getmasternodestatus, true },
        {"FUCHA", "getmasternodewinners", &getmasternodewinners, true },
        {"FUCHA", "getmasternodescores", &getmasternodescores, true },
        {"FUCHA", "mnsync", &mnsync, true },
        {"FUCHA", "spork", &spork, true },
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:26144/\n";
}
