// Copyright (c) 2017-2018 The fucha developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef fucha_ZfuchaWALLET_H
#define fucha_ZfuchaWALLET_H
...
public:
    CzfuchaWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZfucha(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZfucha(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
