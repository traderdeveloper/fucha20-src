...
#ifndef fucha_ZfuchaTRACKER_H
#define fucha_ZfuchaTRACKER_H
...
public:
    CzfuchaTracker(std::string strWalletFile);
    ~CzfuchaTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzfuchaWallet* zfuchaWallet = NULL);
