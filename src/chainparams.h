 ...
 * fucha system. There are three: the main network on which people trade goods
...
public:
    ...
    int fuchaBadBlockTime() const { return nfuchaBadBlockTime; }
    int fuchaBadBlocknBits() const { return nfuchaBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nfuchaBadBlockTime;
    unsigned int nfuchaBadBlocknBits;
