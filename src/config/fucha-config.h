/* src/config/fucha-config.h.  Generated from fucha-config.h.in by configure.  */
/* src/config/fucha-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef fucha_CONFIG_H

#define fucha_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/traderdeveloper/fucha/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "fucha Coin"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "fucha Coin 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "fucha"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://fucha.rocks/"
