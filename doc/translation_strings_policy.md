...
This document provides guidelines for internationalization of the fucha Coin software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to fucha network</numerusform>
            <numerusform>%n active connections to fucha network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `fucha_en.ts` remains unchanged.
