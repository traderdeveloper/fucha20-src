...
The script [extract-osx-sdk.sh](https://github.com/traderdeveloper/fucha/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
fucha/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/traderdeveloper/fucha/blob/master/doc/README_osx.md) for troubleshooting tips.