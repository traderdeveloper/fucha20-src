...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='FUCHA.conf'
CONFIGFOLDER='/root/.FUCHA'
COIN_DAEMON='FUCHAd'
COIN_CLI='FUCHA-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/FUCHA/FUCHA/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
