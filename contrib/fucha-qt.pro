...
RESOURCES += src/qt/fucha.qrc src/qt/fucha_locale.qrc

TRANSLATIONS += src/qt/locale/fucha_bg.ts \
                src/qt/locale/fucha_de.ts \
                src/qt/locale/fucha_en.ts \
                src/qt/locale/fucha_es.ts \
                src/qt/locale/fucha_fi.ts \
                src/qt/locale/fucha_fr.ts \
                src/qt/locale/fucha_it.ts \
                src/qt/locale/fucha_ja.ts \
                src/qt/locale/fucha_pl.ts \
                src/qt/locale/fucha_pt.ts \
                src/qt/locale/fucha_ru.ts \
                src/qt/locale/fucha_sk.ts \
                src/qt/locale/fucha_sv.ts \
                src/qt/locale/fucha_vi.ts \
                src/qt/locale/fucha_zh_CN.ts \
                src/qt/locale/fucha_zh_TW.ts
