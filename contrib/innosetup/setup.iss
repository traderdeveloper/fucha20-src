...
#define MyAppName "FUCHA Core"
#define MyAppPublisher "2021-2022 The FUCHA Developers"
#define MyAppURL "https://github.com/traderdeveloper//FUCHA"
#define MyAppExeName "FUCHA-qt.exe"
#define MyAppExtraData "https://github.com/traderdeveloper//FUCHA/releases/download/v2.0/bootstrap.zip"
...
[Files]
Source: ".\package\FUCHA-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\FUCHA\FUCHA-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\FUCHA\FUCHA-Qt,strDataDir|{userappdata}\FUCHA\}');
  Result := True;
end;
