...
* Fill in the following data:
    * Application Name: `FUCHA Core`
    * Application Version: `2.0.0.0`
    * Application Publisher: `2021-2022 The FUCHA Developers`
    * Application Website: `https://fucha.rocks/`
* Setup the destination folder:
    * Program Files Folder
    * Folder name: `FUCHA`
* Add application files:
    * Select the file `FUCHA-qt.exe` as main executable from the `package` folder
...
* Compiler settings
    ...
    * Edit the output base filename to: `FUCHA-2.0.0-win64-setup.exe`
