...
from test_framework.fucha_node import fuchaTestNode
...
class fucha_ColdStakingTest(BitcoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(fuchaTestNode())
