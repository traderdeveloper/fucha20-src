...
from fake_stake.base_test import fucha_FakeStakeTest

class zfuchawrappedSerialsTest(fucha_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zfuchas..." % DENOM_TO_USE)
