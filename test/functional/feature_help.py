...
"""Verify that starting FUCHA with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start FUCHA with -? for help text")
        ...
        self.log.info("Start FUCHA with -version for version information")
