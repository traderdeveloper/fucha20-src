Contributing to FUCHA Core
============================

The FUCHA Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Tests* for changes to the FUCHA Coreunit tests or QA tests
...
The following applies to code changes to the FUCHA Core project, and is not to be
confused with overall FUCHA Network Protocol consensus changes.

Whether a pull request is merged into FUCHA Core rests with the project merge
...
The project leader is the release manager for each FUCHA Core release.
