Contributing to fucha Coin
============================

The fucha Coin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/traderdeveloper/fucha/blob/master/doc/translation_process.md)
...
The following applies to code changes to the fucha Coin project, and is not to be
confused with overall fucha Network Protocol consensus changes.

Whether a pull request is merged into fucha Coin rests with the project merge
...
Patches that change fucha consensus rules are considerably more involved than
...
Where a patchset proposes to change the fucha consensus, it must have been
...
The project leader is the release manager for each fucha Coin release.
